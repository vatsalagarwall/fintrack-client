                ...
                <div className='dashboard-container'>
                    <div className='filters'>
                        <div className='filter'>
                            <h6>Select Frequency</h6>
                            <Select value={frequency} onChange={(value) => setFrequency(value)} style={{ width: 160 }}>
                        ...
                        <div className='filter'>
                            <h6>Select Type</h6>
                            <Select value={type} onChange={(value) => setType(value)} style={{ width: 160 }}>
                                <Select.Option value="all">All</Select.Option>
                                <Select.Option value="income">Income</Select.Option>
                                <Select.Option value="expense">Expense</Select.Option>
                            </Select>
                    ...
                    <div className='content'>
                        {viewData === 'table' ?
                            ...
                            </div>) : (<div className='analytics-container'>
                                <Analytics allTransactions={allTransactions} />
                            </div>)}
                    </div>
                    <div className='footer'>
                        <h6>All rights reserved | Fintrack App</h6>
                    </div>
                    <Modal
                        title={editable ? 'Edit Transaction' : 'Add Transaction'}
                        open={showModal}
                    ...
                    >
                        <Form layout='vertical' onFinish={handleSubmit} initialValues={editable}>
                            ...
                            <div className='d-flex justify-content-end'>
                                <button className='logout-button' type='submit'>SAVE</button>
                            </div>
                        </Form>
                    </Modal>
                </div>
